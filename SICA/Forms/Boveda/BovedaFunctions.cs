    ...
    class BovedaFunctions
    {
        ...
        public static bool GuardarDocCarrito()
        {
            ...
            try
            {
                ...
                strSQL = "SELECT TC.ID_INVENTARIO_GENERAL_FK AS ID, IG.ID_REPORTE_VALORADOS_FK AS ID_REPORTE, '0' AS NRO, DESCRIPCION_1, DESCRIPCION_2, DESCRIPCION_3, DESCRIPCION_4 FROM TMP_CARRITO TC";
        ...
        public static bool GuardarCajaCarrito()
        {
            ...
            try
            {
                ...
                strSQL = "SELECT ID_INVENTARIO_GENERAL AS ID, NUMERO_DE_CAJA, DESCRIPCION_1, DESCRIPCION_2, DESCRIPCION_3, DESCRIPCION_4 FROM TMP_CARRITO TC";
