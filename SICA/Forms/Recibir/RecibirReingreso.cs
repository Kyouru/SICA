    ...
    public partial class RecibirReingreso : Form
    {
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strSQL += " LEFT JOIN USUARIO U ON U.USERNAME = IG.USUARIO_POSEE";
                strSQL += " WHERE TC.ID_TMP_CARRITO IS NULL AND (CUSTODIADO = 'PRESTADO' OR CUSTODIADO = 'DEVUELTO') AND U.CUSTODIA = FALSE AND U.REAL2 = TRUE";
