        ...
        private void btGenerar_Click(object sender, EventArgs e)
        {
            if (tbCargoCajas.Text != "")
            {
                ...
                try
                {
                    ...
                    strSQL = "SELECT 'PY121' AS CODIGO_CLIENTE, NUMERO_DE_CAJA, CAJA_CLIENTE, 'MASTER' AS CODIGO_DIVISION, DEP.NOMBRE_DEPARTAMENTO AS DEPART, DOC.NOMBRE_DOCUMENTO AS DOC, FORMAT(FECHA_DESDE, 'dd/MM/yyyy') AS FECHA_DESDE, FORMAT(FECHA_HASTA, 'dd/MM/yyyy') AS FECHA_HASTA, DESCRIPCION_1, DESCRIPCION_2, DESCRIPCION_3,";
