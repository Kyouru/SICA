...
{
    public partial class IronMountainSubMain : Form
    {
        private IconButton currentBtn;
        private Panel topBorderBtn;
        private Form currentChildForm;

        public IronMountainSubMain()
        {
            InitializeComponent();
        ...
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new IronMountainRecibir());
        }
        ...
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new IronMountainEnviar());
        }
        ...
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new IronMountainCargo());
        }
    }
